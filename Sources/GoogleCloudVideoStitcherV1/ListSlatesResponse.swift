...
public struct ListSlatesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSlatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSlatesResponse().with { $0.slates = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let slates = CodingKeys(stringValue: "slates")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Slate].self, forKey: .slates) {
      self.slates = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.slates, forKey: .slates)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.stitcher.v1.ListSlatesResponse"
  }
  ...
  public func _getPaginatedItems() -> [Slate] {
    return self.slates
  }
