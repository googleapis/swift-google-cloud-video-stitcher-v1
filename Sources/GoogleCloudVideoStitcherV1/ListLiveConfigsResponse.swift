...
public struct ListLiveConfigsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// List of live configs.
  public var liveConfigs: [LiveConfig] = []
  ...
  /// Initialize a new instance of `ListLiveConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLiveConfigsResponse().with { $0.liveConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let liveConfigs = CodingKeys(stringValue: "liveConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([LiveConfig].self, forKey: .liveConfigs) {
      self.liveConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.liveConfigs, forKey: .liveConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.stitcher.v1.ListLiveConfigsResponse"
  }
