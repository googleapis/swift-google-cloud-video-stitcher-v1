  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = VodStitchDetail().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let adStitchDetails = CodingKeys(stringValue: "adStitchDetails")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AdStitchDetail].self, forKey: .adStitchDetails) {
      self.adStitchDetails = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.adStitchDetails, forKey: .adStitchDetails)
