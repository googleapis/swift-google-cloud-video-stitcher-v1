...
public struct ListCdnKeysResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// List of CDN keys.
  public var cdnKeys: [CdnKey] = []
  ...
  /// Initialize a new instance of `ListCdnKeysResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCdnKeysResponse().with { $0.cdnKeys = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cdnKeys = CodingKeys(stringValue: "cdnKeys")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([CdnKey].self, forKey: .cdnKeys) {
      self.cdnKeys = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.cdnKeys, forKey: .cdnKeys)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.stitcher.v1.ListCdnKeysResponse"
  }
  ...
  public func _getPaginatedItems() -> [CdnKey] {
    return self.cdnKeys
  }
