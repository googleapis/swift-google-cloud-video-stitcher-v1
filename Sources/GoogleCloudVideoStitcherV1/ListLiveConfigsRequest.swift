...
public struct ListLiveConfigsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLiveConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLiveConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.stitcher.v1.ListLiveConfigsRequest"
  }
