...
public struct GamLiveConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var assetKey: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = GamLiveConfig().with { $0.networkCode = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.stitcher.v1.GamLiveConfig"
  }
