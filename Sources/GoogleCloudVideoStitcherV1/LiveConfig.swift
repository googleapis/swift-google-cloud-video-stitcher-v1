...
public struct LiveConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum StitchingPolicy: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("STITCHING_POLICY_UNSPECIFIED")
      case .cutCurrent: return try container.encode("CUT_CURRENT")
      case .completeAd: return try container.encode("COMPLETE_AD")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
