  ...
  public func createCdnKey(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try CdnKey(fromAny: anyValueUnwrapped)
  ...
  public func createSlate(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try Slate(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createLiveConfig(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try LiveConfig(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createVodConfig(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try VodConfig(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
